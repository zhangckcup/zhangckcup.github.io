...
中国的城市住房制度改革是1978年启动的“改革开放”政策的重要组成部分，导致该国大多数城市人口的住所得到了普遍而显着的改善。在将近40年的时间里，中央和地方政府已经成功地为中国80%的城市人口提供了质量合理的新型自有住房和补偿住房。与此同时，房地产在过去两年中一直是中国快速增长的重要引擎几十年。根据国家统计局的数据，房地产投资从1997年约占GDP的4%增长到2017年占GDP的13.27%。2017年，特别是住宅开发对房地产的投资达到了创历史新高的0.751万亿元人民币（1115.2亿美元），较2016年的0.687万亿元人民币增长9.4%。随着对房地产投资的增加，房价也稳步上涨，从2005年到2017年，北京的房价以每年43%的速度飞速增长，对民生和房地产开发产生了巨大的不利影响。2018年3月15日，由中国人民银行委托进行的一项调查显示，在50个城市的样本中，有62.9％的城市居民认为房价已经变得“高得令人无法接受”。

在北京房价高居不下的同时，外来人口数量巨大，据北京市统计局数据，2019年末北京市常住人口共2153.6万人，其中常住外来人口共764.6万人。对比美国36.3%的房屋租赁比例和日本35.5%的房屋租赁比例，我国目前的房屋租赁比率仅达到11.6%；另一方面，相对于美国、日本主要城市高达50%的房屋租赁比例，我国主要城市的房屋租赁比例仅在30%左右，侧面反映出我国当前的房屋租赁需求存在着相当大的增长空间。国家也颁布了相关支持政策，2017年7月，九大部门委员会共同颁布了《关于在人口净流入的大中城市加快发展住房租赁市场的通知》，文件指出，在人口流入大于人口流出的各个大中城市，要大力发展房屋租赁，同时选择了广州、深圳等12个地区作为试验点。按照“十三五”规划，北京、上海、广州等地区将在“十三五”期间增加政府租赁房50万套、70万套、15万套。

租房问题也成为全社会关注的焦点问题之一，房屋租赁市场正在逐渐成为人们满足住房需求的主要方式。线上房屋租赁在互联网影响下成为房屋租赁的主要途径，线上房屋租赁的定价规则在一定程度上也反映了影响房屋租赁价格的主要因素。因此，通过网络上已有信息预测房屋租赁价格具有一定可行性。

### 1.2 文献综述

在国内关于房价分析的研究中，使用的模型主要有GM(1,1)模型[1,4,5,6]和多元线性模型[1,2,12]，其中多元线性模型由使用方式的不同，又有空间异质性定量分析方法——地理加权回归分析 (Geographically weighted regression, GWR)[13]与提取不同特征进行分析的特征模型法（Hedonic model）[8,9]。如果选取样本的维度较大，可使用主成分分析法[2]将样本数据中多个变量合成一个复合变量，对数据进行降维。当样本数据涉及时间序列时，除了使用GM(1,1)模型[1,4,5,6]进行预测，也有学者使用ARMA模型[15]，马尔可夫模型[3]进行房价预测。近些年，随着数据挖掘、机器学习等统计方法的兴起，这些方法也被用作房价预测的手段[5,7,11]。

相关文献对于影响房屋租赁价格因素的选取，首先是空间因素，这点多数文章都有考虑。空间因素中，包括单纯的经纬度因素[5]，以及周围交通情况（如地铁站、所处的小区等）等[13]更精确的条件。李晓鹏[8]在研究北京住宅价格时，引入了“是否位于北京市十二所重点小学学区内”定性指标，并使用了hedonic模型，得到上述定性指标与房价有32%的关联度。此外，还有宏观经济因素，如居民收入水平、国民经济发展水平、利率、金融机构贷款余额等[7,13]。在房屋本身方面，房屋租赁价格与房屋面积、房屋卧室数量两个因素有较高关联性[8]。在以上文献中，由于选取的数据大多是城区的房屋，所以所处位置对租价影响较小，故这一因素未被考虑。

### 1.3 论文的主要内容和方法

本文总共分为五个章节：

第一章介绍选题背景，对有关房屋租赁价格影响因素和预测模型的文献进行综述，简介论文的思路、方法以及内容。
...
我们在研究房价的影响因素时，需要考虑多个变量，有宏观指数如GDP、居民人均可支配收入、固定资产投资增速等，此外还有土地价格、央行利率、就业率等因素。变量和数据很多，难免存在噪声和冗余。同时，这些变量有些是相关的，那么就可以从相关的变量中选择一个，或将几个变量综合为一个变量作为代表。用少数变量代表多少变量即是降维。

主成分分析能将高维数据转换为低维数据进行研究，所得到的维度较低的综合指标之间互不相关，又能提供原有数据的绝大部分信息。而且，在进行主成分分析的同时，可得到各主成分的权重，这在很大程度上抵制了在评价过程中主观因素的干扰，因此以主成分为基础的模型因素的选取能够较好地保证预测结果的客观性。

主成分分析的基本思路可概述如下：借助一个正交变换，将分量相关的原随机变量转换成分量不相关的新变量，从代数角度，即将原变量的协方差阵转换成对角阵。从几何角度，将原变量系统变成新的正交系统，使之指向样本点散布最开的正交方向，进而对多维变量系统进行降维处理。按照特征提取的观点，主成分分析相当于一种基于最小均方误差的提取方法。[16]
...
![北京市各区房屋平均租赁价格比较](img/050705.png)
...
![所选区域真实值与模型预测值比较](img/050707.png)
